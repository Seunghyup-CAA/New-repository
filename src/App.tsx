...
const KO: Content = {
  ...
  eventDate: "",
  eventDesc:
    "출판기념회를 준비 중입니다. 일시와 장소가 확정되는 대로 안내드리겠습니다. 많은 관심 부탁드립니다.",
  eventBtn: ["이메일로", "문의하기"],
  about: "책 소개",
  aboutShort:
  ...
  authorLong: [
    ...
    "시카고 한인 문인회 및 남강 문인회 회원이며 Swanvive LLC 대표이사로 활동 중이다. 『신비스러운 강들』은 첫 번째 책 『남강에서 맨해튼까지』에 이은 두 번째 저서이다.",
  ],
  moreAuthor: "자세히 보기",
  footerTitle: "구매 및 문의",
...
const EN: Content = {
  ...
  eventDate: "",
  eventDesc:
    "We are currently planning the book launch event. Details on the date and venue will be announced soon. Thank you for your interest.",
  ...
  authorLong: [
    ...
    "He is a member of the Chicago Korean Literary Society and the Namgang Literary Society, and the founder of Swanvive LLC. My Mysterious Rivers is his second book, following Namgang to Manhattan.",
  ],
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-8 rounded-[28px] bg-white p-6 shadow md:grid-cols-[280px_minmax(0,1fr)] md:p-8">
          ...
          <div>
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              ...
              <a href="mailto:swanvive0@gmail.com" className="rounded-xl border border-slate-300 bg-white px-5 py-3 text-center font-bold text-slate-900">
                {t.contact}
              </a>
            </div>
          </div>
