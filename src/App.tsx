...
const KO: Content = {
  ...
  aboutLong: [
    "『신비스러운 강들』은 폐암 진단을 받은 여든 살 한인 이민자가 맨해튼 재활원에서 쓴 회고록이다. 가족과 친구에게 보내는 편지, 신앙과 죽음에 대한 묵상, 병동에서 만난 비범한 사람들의 초상, 그리고 고향 진주와 미국 생활을 잇는 에세이—네 부분에 걸쳐, 홍순완은 두 강이 빚어낸 한 생애의 궤적을 그린다. 고도(古都) 진주를 품고 흐르는 남강과, 병실 창 너머로 보이는 허드슨강.",
